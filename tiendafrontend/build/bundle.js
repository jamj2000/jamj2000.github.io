...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li0, "class", "logo svelte-pnc00u");
    			add_location(li0, file$1, 82, 4, 1207);
    			attr_dev(li1, "class", "item active svelte-pnc00u");
    			add_location(li1, file$1, 85, 4, 1275);
    			attr_dev(li2, "class", "item active svelte-pnc00u");
    			add_location(li2, file$1, 88, 4, 1362);
    			attr_dev(ul, "class", "menu svelte-pnc00u");
    			add_location(ul, file$1, 81, 2, 1185);
    			attr_dev(nav, "class", "svelte-pnc00u");
    			add_location(nav, file$1, 80, 0, 1177);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 162, 0, 3449);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Boton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$6, safe_not_equal, { tipo: 2, coleccion: 3, documento: 4 });
    ...
    class Articulo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$7, safe_not_equal, { articulo: 0 });
